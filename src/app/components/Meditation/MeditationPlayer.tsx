...
export default function MeditationPlayer({ onClose, title }: PlayerProps) {
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-[#6B6B6B] flex flex-col items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[850px] aspect-[16/11] rounded-lg overflow-hidden shadow-[0_30px_60px_-12px_rgba(0,0,0,0.5)]">
        <img 
          src="/meditate.png" 
          alt="Meditation" 
        ...
        <div className="absolute bottom-0 left-0 right-0 px-8 pb-8 pt-20 bg-gradient-to-t from-black/40 to-transparent">
          ...
          <div className="w-full mb-6">
            ...
            <div 
              onClick={handleSeek}
              className="relative w-full h-[3px] bg-white/20 rounded-full cursor-pointer group"
            >
              <div 
              ...
              <div className="absolute top-[-4px] right-[-4px] opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
          </div>
